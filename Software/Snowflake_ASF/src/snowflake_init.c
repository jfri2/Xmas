...
struct port_config gpio_input_up { .direction = PORT_PIN_DIR_INPUT, .input_pull = PORT_PIN_PULL_UP };
struct port_config gpio_input { .direction = PORT_PIN_DIR_INPUT, .input_pull = PORT_PIN_PULL_NONE };
